...
//             if (is_unary_operator(node->value.op))
//             {
...
//                 }
//             }
//             else if (is_binary_operator(node->value.op))
//             {
//                 error_l = evaluate_const_node(node->left, &left_val);
//                 if (error_l != SUCCESS)
//                     return error_l;
...
//         default: 
//         {
//             if (!(node->type == VARIABLE || node->type == ROOT))
//             {
//                 ErrorCode error = SUCCESS;
...
//         Node_result_t new_node = create_number_node(tree, result);
//         if (new_node.error != SUCCESS)
//             return NULL;

//         new_node.node->prev = node->prev;
//         destroy_node(node);
...
//     Node_result_t new_node = create_number_node(tree, value);
//     if (new_node.error != SUCCESS)
//     {
...
//     tree->root = optimize_const_node(tree->root, tree);
//     tree->root = optimize_simple_arithmetic(tree->root, tree);
//     return SUCCESS;
// }
